...
var Autocomplete = React3.forwardRef(function Autocomplete2(inProps, ref) {
  ...
  const {
    ...
    className,
    clearIcon = _ClearIcon || (_ClearIcon = (0, import_jsx_runtime2.jsx)(Close_default, {
      fontSize: "small"
    })),
    clearOnBlur = !props.freeSolo,
    clearOnEscape = false,
    ...
    popupIcon = _ArrowDropDownIcon || (_ArrowDropDownIcon = (0, import_jsx_runtime2.jsx)(ArrowDropDown_default, {})),
    readOnly = false,
  ...
  if (multiple && value.length > 0) {
    ...
    if (renderTags) {
      ...
      startAdornment = value.map((option, index) => {
        ...
        return (0, import_jsx_runtime2.jsx)(Chip_default, {
  ...
  if (limitTags > -1 && Array.isArray(startAdornment)) {
    ...
    if (!focused && more > 0) {
      ...
      startAdornment.push((0, import_jsx_runtime2.jsx)("span", {
        className: classes.tag,
  ...
  const defaultRenderGroup = (params) => (0, import_jsx_runtime2.jsxs)("li", {
    children: [(0, import_jsx_runtime2.jsx)(AutocompleteGroupLabel, {
      className: classes.groupLabel,
      ownerState,
      component: "div",
      children: params.group
    }), (0, import_jsx_runtime2.jsx)(AutocompleteGroupUl, {
  ...
  return (0, import_jsx_runtime2.jsxs)(React3.Fragment, {
    children: [(0, import_jsx_runtime2.jsx)(AutocompleteRoot, {
      ref,
      className: clsx_default(classes.root, className),
      ownerState,
      ...getRootProps(other),
        ...
        InputProps: {
          ...
          ...(hasClearIcon || hasPopupIcon) && {
            endAdornment: (0, import_jsx_runtime2.jsxs)(AutocompleteEndAdornment, {
              ...
              ownerState,
              children: [hasClearIcon ? (0, import_jsx_runtime2.jsx)(AutocompleteClearIndicator, {
                ...getClearProps(),
                ...
                children: clearIcon
              }) : null, hasPopupIcon ? (0, import_jsx_runtime2.jsx)(AutocompletePopupIndicator, {
                ...getPopupIndicatorProps(),
                disabled,
    ...
    }), anchorEl ? (0, import_jsx_runtime2.jsx)(AutocompletePopper, {
      as: PopperSlot,
      ...popperProps,
      children: (0, import_jsx_runtime2.jsxs)(AutocompletePaper, {
        as: PaperSlot,
        ...paperProps,
        children: [loading && groupedOptions.length === 0 ? (0, import_jsx_runtime2.jsx)(AutocompleteLoading, {
          className: classes.loading,
          ownerState,
          children: loadingText
        }) : null, groupedOptions.length === 0 && !freeSolo && !loading ? (0, import_jsx_runtime2.jsx)(AutocompleteNoOptions, {
        ...
        }) : null, groupedOptions.length > 0 ? (0, import_jsx_runtime2.jsx)(ListboxSlot, {
...
//# sourceMappingURL=chunk-K6ALFM4B.js.map
